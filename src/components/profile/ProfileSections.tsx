    ...
    <div className="px-5 py-5 group">
      ...
      >
        <div className="flex items-center gap-2 flex-1">
          <h3 className="font-bold text-foreground text-[14px] uppercase tracking-wide">My Uploaded Referrals</h3>
          <span className="text-[10px] font-bold bg-[#5C45FD] text-white px-2 py-0.5 rounded-full shadow-sm">{contacts.length}</span>
        </div>
        <div className="flex items-center gap-3">
          <Link 
            href="/upload-referral" 
            onClick={(e) => e.stopPropagation()} 
            className="text-[10px] font-bold bg-emerald-50 text-emerald-600 px-2.5 py-1 rounded-md border border-emerald-200 hover:bg-emerald-100 transition-colors shadow-xs"
          >
            + ADD REFERRAL
          </Link>
